...
class Kraph(f: Kraph.() -> Unit) {
    ...
    inner open class FieldBuilder {
        ...
        fun field(name: String, alias: String? = null, args: Map<String, Any>? = null) {
            addField(name, alias, args)
        }
        ...
        fun func(name: String, args: Map<String, Any>, alias: String? = null, builder: FieldBlock) {
            fields += Mutation(name, alias, InputArgument(args), createSelectionSet(name, builder))
        }

        protected fun addField(name: String, alias: String?, args: Map<String, Any>? = null, builder: FieldBlock? = null) {
